 ...
 * @mixin AudioMath
 */
export const AudioMath = (function() {
    var exp = Math.exp;
    var log = Math.log;
    var pow = Math.pow;
    var MAX = Math.max;
